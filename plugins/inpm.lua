...
local name_log = user_print_name(msg.from)
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "Welcome to Robot!\n\nThis is a bot run by @mohammad32188 for managing the official group @spambot_ssbot on Telegram\n\nCheck out our channel @channel\n\nAlso join To Group Support https://t.me/joinchat/F0_6N0iJ20oZIINNIyFLdw for knowing more!"
     	return text
    end
